        ...
        <div className={`app ${toggled ? 'toggled' : ''}`}>
            ...
            <main>
                ...
                <Switch>
                    ...
                    <Route path="/login" exact render={(props) => (<Login {...props} dark={dark} />)} />
                    <Route path="/dashboard" exact render={(props) => (<Dashboard {...props} dark={dark} />)} />
                    <Route path="/form-saude" exact render={(props) => (<iframe src="https://docs.google.com/forms/d/e/1FAIpQLScE2Z3sgh76hgmI-2pAu_-RSZuelifuAE2yzhm45jjMsDzjmw/viewform?embedded=true" width="100%" height="100%" frameborder="0" marginheight="0" marginwidth="0">Carregando…{document.title='Cadastro de Processos de Saúde'}</iframe>)} />
